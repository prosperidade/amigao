  ...
  return (
    <div className="max-w-7xl mx-auto space-y-4">
      ...
      {/* Área 3 — Barra horizontal de tabs (ex-menu lateral).
          Alinhado com Lovable da sócia: só barra superior, sem menu lateral duplicado.
          CAM3WS-002 (Sprint N) preservado: filtra tabs condicionais (min_stage_index)
          e marca tabs 'active' como "herdado" quando o usuário filtra por etapa passada
          ...
          {TABS.map(tab => {
            ...
            return (
              ...
              >
                ...
                <span>{tab.label}</span>
                {isInherited && (
                  <span className="text-[9px] uppercase tracking-wide text-gray-400 dark:text-slate-500">herd.</span>
                )}
              </button>
            );
          })}
      ...
      {/* Layout 2 colunas: área central + painel direito */}

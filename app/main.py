...
app.include_router(messaging.router, prefix=f"{settings.API_V1_STR}/messaging", tags=["Mensageria / Canais"])
...
app.include_router(geometria.router, prefix=f"{settings.API_V1_STR}/processes", tags=["Geometria"])

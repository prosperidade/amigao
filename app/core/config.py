...
class Settings(BaseSettings):
    ...
    # (dedupe do ADR-078). 1 = uma leitura, como até aqui. O número é decisão do André
    # sobre a medição do ADR (cobertura × custo × tempo); o custo e o tempo multiplicam.
    AI_EXTRATOR_LEITURAS_POR_RODADA: int = Field(default=1, ge=1, le=3)

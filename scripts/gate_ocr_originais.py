...
Uso
---
    # 1) credenciais do storage de PRODUÇÃO (R2), só leitura, no ambiente:
    export MINIO_SERVER=<accountid>.r2.cloudflarestorage.com
    export MINIO_ACCESS_KEY=...  MINIO_SECRET_KEY=...
    export MINIO_SECURE=True     S3_REGION=auto     # R2 exige region "auto"

    # 2) o lado de produção, exportado do banco (id, storage_key, extracted_text):
    ...
    python scripts/gate_ocr_originais.py --producao docs23_prod.json \\
           --saida docs/trabalhos/ocr_originais/
